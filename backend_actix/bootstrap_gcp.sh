...
# ------------------------------------------------------------
# Step 4: Grant Secret Manager access to default compute SA
# ------------------------------------------------------------
echo "==> Granting Secret Manager access to Cloud Run service account..."
COMPUTE_SA="${PROJECT_ID//:/_}@cloudservices.gserviceaccount.com"
...
echo "==> Granted secretAccessor role to ${DEFAULT_COMPUTE_SA}"
echo
