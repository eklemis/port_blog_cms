...
#[openapi(
    ...
    paths(
        ...
        crate::ai::adapter::incoming::web::routes::extract_job_handler,
        crate::ai::adapter::incoming::web::routes::tailor_handler,
        crate::ai::adapter::incoming::web::routes::cover_letter_handler,
        ...
        crate::multimedia::adapter::incoming::web::routes::reap_uploads_handler,
    ...
    components(
        schemas(
            ...
            crate::career::domain::relevance::RelevanceReport,
            crate::career::domain::relevance::RequirementMatch,
            crate::career::domain::relevance::Verdict,
